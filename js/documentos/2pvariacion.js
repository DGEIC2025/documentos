...
async function generateDocument() {
    ...
    const campos = ['oficio', 'remitente', 'cargo', 'diao' , 'meso' ,'dia' , 'year', 'numeromes', 'mes' , 'carpeta' , 'imputado' ,'variacion', 'imputadov', 'nombre']
    ...
    const templateUrl = 'documentos/2pvariacion.docx'; // URL o ruta del archivo de plantilla
    let arrayBuffer;
