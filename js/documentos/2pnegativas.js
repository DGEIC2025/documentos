...
async function generateDocument() {
    ...
    const campos = ['oficio', 'remitente', 'cargo', 'diao' , 'meso' ,'dia' , 'year', 'numeromes', 'mes' , 'carpeta' , 'imputadop' , 'imputadon', 'nombre']
    ...
    const templateUrl = 'documentos/2pnegativas.docx'; // URL o ruta del archivo de plantilla
    let arrayBuffer;
