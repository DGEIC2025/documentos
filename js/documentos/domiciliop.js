...
async function generateDocument() {
    ...
    const campos = ['oficio', 'remitente', 'cargo', 'diao' , 'meso' ,'dia' ,'year', 'numeromes', 'mes' , 'carpeta' , 'imputado' , 'nombre', 'domicilio'];
    ...
    const templateUrl = 'documentos/domiciliop.docx'; // URL o ruta del archivo de plantilla
    let arrayBuffer;
