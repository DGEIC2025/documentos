...
async function generateDocument() {
    ...
    const campos = ['oficio', 'diao' , 'meso' ,'dia' , 'numeromes', 'mes' , 'year', 'carpeta' , 'imputado' , 'nombre']
    ...
    const templateUrl = 'documentos/colaboracionp.docx'; // URL o ruta del archivo de plantilla
    let arrayBuffer;
